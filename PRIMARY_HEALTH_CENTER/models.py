...
class ChildVaccination(models.Model):
    ...
    email=models.EmailField()  
    vaccination_1month=models.CharField(max_length=50)
    vaccination_2month=models.CharField(max_length=50)
    vaccination_3month=models.CharField(max_length=50)
    vaccination_6month=models.CharField(max_length=50)
    vaccination_7month=models.CharField(max_length=50)
    vaccination_8month=models.CharField(max_length=50)
    vaccination_9month=models.CharField(max_length=50)
    vaccination_12month=models.CharField(max_length=50)
    vaccination_15month=models.CharField(max_length=50)
    vaccination_18month=models.CharField(max_length=50)
    vaccination_24month=models.CharField(max_length=50)
    vaccination_36month=models.CharField(max_length=50)
    vaccination_48month=models.CharField(max_length=50)
    vaccination_60month=models.CharField(max_length=50)
